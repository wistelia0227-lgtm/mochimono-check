...
const VERSION = 'mochimono-v0.4';
const FILES = [
  './', 'index.html', 'manifest.webmanifest', 'css/style.css',
  'js/util.js', 'js/db.js', 'js/master.js', 'js/model.js', 'js/app.js',
  'modules/stay.js', 'modules/residents.js', 'modules/search.js', 'modules/settings.js', 'modules/print.js', 'modules/pickfrom.js', 'modules/lab.js', 'modules/devtools.js',
